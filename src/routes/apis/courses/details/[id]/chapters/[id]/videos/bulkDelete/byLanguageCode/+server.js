...
export async function DELETE({ params, cookies, url }) {
	...
	let res;
	try {
		// bulk delete videos in a chapter in a course by language code
		res = await fetch(`${BASE_URL}/apis/v1/courses/${courseUuid}/chapters/${chapterUuid}/videos/language/${languageCode}`, {
			method: 'DELETE',
			headers: {
