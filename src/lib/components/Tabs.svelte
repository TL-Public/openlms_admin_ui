	...
	<nav class="flex flex-row flex-wrap">
		{#each tabs as tab}
			<button
				...
				class=" whitespace-nowrap cursor-pointer border-b-2 px-4 py-3 text-sm font-medium text-darkGray hover:bg-gray-10 hover:border-accent-hover hover:text-gray-700 {tab?.text ===
				activeTab?.text
					? 'border-accent  hover:bg-gray-30 bg-gray-30 font-semibold'
