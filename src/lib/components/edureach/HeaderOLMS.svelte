<script>
    ...
    import EdureachLogoMobile from '$lib/svgComponents/edureach/EdureachLogoMobile.svelte';
...
<header
	class=" h-16 sticky top-0 sm:h-20 py-2 px-4 flex justify-between lg:py-2 lg:px-20 items-center bg-blue-10 text-darkGray shadow-md w-full z-[90]"
>
